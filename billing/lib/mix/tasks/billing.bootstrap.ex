defmodule Mix.Tasks.Billing.Bootstrap do
  ...
  @moduledoc """
  Creates the `billing` Postgres role and schema, idempotently, using superuser credentials from `BOOTSTRAP_PG_*` environment variables.
  """
  ...
  @doc "Runs priv/repo/bootstrap.sql against Postgres to create the `billing` role and schema."
  @impl Mix.Task
  def run(_args) do
