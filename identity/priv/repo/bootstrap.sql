-- Bootstrap for `identity`'s Postgres role + schema (PLAN.md "Data layer":
...
-- (core/priv/repo/bootstrap.sql), just renamed core -> identity throughout.
--
...
-- Structural isolation, not convention (seed.md §5): `identity` cannot
